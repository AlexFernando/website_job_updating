...
var arrLang = {
    "en-gb": {
        ...
        "language": "  Language",
        "language-li": "We offer English & Spanish Walking Tours, everyday at 10am, 12:30pm, and 3:30pm",
        "duration": "  Duration",
        "duration-li": "2.5 to 3 hours approx.",
        "recognize": "  How do you recognize our official tour guides?",
        "recognize_li": "Look for Wild Free Walking Tour logo on Orange T-shirt at the correct Meeting Point: Plazoleta Espinar (In front of \"La Merced\" church, one block away from the Main Square",
        "price": "  Tour Type & Price",
        "price-li": "This is a Group tour, focused on history, traditions and local lifestyle. it is completely free to book, once the tour is done, leave your Generous and Personal Donation, that will help us to continue with our work.",
        "book-details": "  How to book?",
        "book-details-li": "Click on in the Navigation Bar, or click on the Book Now buttons.",
        "book-details-li-2": "Fill out the form.",
        "book-details-li-3": "You will receive a email confirmation within the next minutes.",
        "advice": "  Please Bring",
        "advice-li": "Do always bring jumper, good walking shoes, hat, sunglasses, water and most importantly rain coats or ponchos",
    ...
    "es": {
        ...
        "language": "  Lenguaje",
        "language-li": "Ofrecemos caminatas guiadas en español e inglés, todos los días, en los horaios 10:00am, 12:30pm, and 3:30pm",
        "duration": "  Duración",
        "duration-li": "2.5 a 3 horas approx.",
        "recognize": "  ¿Cómo reconocer a nuestros Guías Oficiales?",
        "recognize_li": "Busca el polo color naranja con el logo de Wild Free Walking Tour, en nuestro único Punto de Encuentro: Plazoleta Espinar (Frente a la Iglesia \"La Merced\", que se encuentra a un bloque de la Plaza de Armas",
        "price": "  Tipo de Tour & Precio",
        "price-li": "Consiste en una caminata grupal, dónde se hablará y mostrará  historia, tradiciones y el estilo de vida local. Es completamente gratis reservar, una vez que el recorrido haya terminado, deje su Donación generosa y personal, la cuál nos ayudará a continuar con nuestro trabajo.",
        "book-details": "  ¿Cómo reservar?",
        "book-details-li": "Haga clic en en la barra de navegación o haga clic en los botones Reservar ahora.",
        "book-details-li-2": "Llene el Formulario.",
        "book-details-li-3": "Recibirá un correo de confirmación en los siguientes minutos.",
        "advice": "  Por favor, recomendamos traer",
        "advice-li": "Siempre traiga buenos zapatos para caminar, sombrero, gafas de sol, agua y lo más importante, impermeables o ponchos.",
